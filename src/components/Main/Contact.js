        ...
        <div>
            ...
            <section className="contact row m-0">
                <div className="col contact-area text-center text-light mb-0 p-4">
                    ...
                    <a href="mailto:andreakosnick@gmail.com" className="btn btn-outline-light btn-lg mt-5 px-5" role="button" data-toggle="modal" data-target="#ContactModal">Contact</a>
                </div>
            </section>
        </div>
    );
