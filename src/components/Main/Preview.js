                    ...
                    <div className="col-sm-12 col-lg-5">
                        <div className="card textbox bg-primary p-4 text-center">
                            <div className="card-body text-textColor">
                                ...
                                <p className="card-text">I always loved programming and over the past years I teached myself how to code, mostly with resources over the web. I started with making simple applications for Windows, but soon after I found myself learning about the web development. Lately, I enjoy developing the front-end and sometimes also the backend for web apps and websites, although I never stop coding scientific applications, mostly on my field of study.</p>
                            </div>
                        </div>
                    </div>
                </div>
